...
const DigitalMarketing = () => {
  ...
  const courseHighlights = [
    ...
    { icon: BookOpen, text: "Digital Marketing Curriculum" }
  ];
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Digital Marketing Course - SEO, Social Media, PPC Training"
        description="Master Digital Marketing with comprehensive training in SEO, SEM, Social Media Marketing, Google Ads, Email Marketing, Content Strategy. Get certified and start your digital marketing career."
        keywords="digital marketing course, SEO training, social media marketing, Google Ads, digital marketing certification, online marketing course, digital marketing institute"
        canonical="/digital-marketing"
        ogImage="/images/dm.jpg"
        category="Non-IT Courses"
      />
      <CourseStructuredData 
        name="Digital Marketing Course"
        description="Complete Digital Marketing training covering SEO, SEM, Social Media Marketing, Google Ads, Analytics, Email Marketing, and Content Strategy."
        url="https://quastech.co.in/digital-marketing"
        duration="P4M"
        courseMode="blended"
        image="https://quastech.co.in/images/dm.jpg"
      />
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our Digital Marketing program covers all aspects of online marketing and digital strategy.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Target, title: "SEO & SEM", desc: "Search engine optimization" },
                { icon: Code, title: "Social Media", desc: "Facebook, Instagram, LinkedIn" },
                { icon: TrendingUp, title: "Analytics", desc: "Google Analytics & tracking" },
                { icon: Star, title: "Real Projects", desc: "Live campaign management" }
              ].map((item, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {careerOpportunities.map((role, index) => (
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm">High demand role in marketing industry</p>
                  </motion.div>
                ))}
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our comprehensive program and become a skilled digital marketer.
              </p>

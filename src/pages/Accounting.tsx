...
const Accounting = () => {
  ...
  const courseHighlights = [
    ...
    { icon: BookOpen, text: "Accounting Curriculum" }
  ];
  ...
  return (
    <DarkModeProvider>
      <SEO 
        title="Accounting Course - Tally, GST, Financial Accounting Training"
        description="Learn professional accounting with comprehensive training in Tally ERP, GST, Financial Accounting, Taxation, and Bookkeeping. Get industry certification and job placement assistance."
        keywords="accounting course, tally training, GST course, financial accounting, bookkeeping course, accounting certification, tally ERP training"
        canonical="/accounting"
        ogImage="/images/Non It Course Image/Accounting.jpg"
        category="Non-IT Courses"
      />
      <CourseStructuredData 
        name="Accounting Course"
        description="Professional accounting training covering Tally ERP, GST, Financial Accounting, Taxation, Auditing, and practical bookkeeping skills."
        url="https://quastech.co.in/accounting"
        duration="P3M"
        courseMode="blended"
        image="https://quastech.co.in/images/Non It Course Image/Accounting.jpg"
      />
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background">
          ...
          <div className="relative z-10 container mx-auto px-4 text-center text-white">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                Master basic accounting principles and bookkeeping practices
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our Accounting program covers fundamental accounting concepts and practical bookkeeping skills.
              </p>
            </motion.div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { icon: Code, title: "Bookkeeping", desc: "Basic accounting principles" },
                { icon: Target, title: "Ledger Management", desc: "Journal & ledger entries" },
                { icon: TrendingUp, title: "Reconciliation", desc: "Bank & account reconciliation" },
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {careerOpportunities.map((role, index) => (
                  ...
                  >
                    ...
                    <p className="text-gray-600 text-sm">High demand role in accounting industry</p>
                  </motion.div>
                ))}
              </div>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-extrabold mb-6">
                Ready to Master Accounting?
              </h2>
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Join our comprehensive program and become a skilled accounting professional.
              </p>

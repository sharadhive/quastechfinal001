...
const FullStackDotNetDevelopment = () => {
  ...
  const highlights = [
    { title: "ASP.NET Core", icon: Code, description: "Modern .NET framework" },
    { title: "C# Programming", icon: Code, description: "Master C# language" },
    { title: "SQL Server", icon: Database, description: "Database development" },
    { title: "Real Projects", icon: Laptop, description: "Hands-on experience" },
  ];

  const modules = [
    { title: "C# Fundamentals", topics: ["C# Basics", "OOP Concepts", "LINQ", "Async Programming"] },
    { title: "ASP.NET Core", topics: ["MVC Architecture", "Web API", "Entity Framework", "Authentication"] },
    { title: "Frontend Integration", topics: ["Razor Pages", "Blazor", "React Integration", "Angular Integration"] },
    { title: "Database & Deployment", topics: ["SQL Server", "Azure Deployment", "CI/CD", "Best Practices"] }
  ];

  const careerOpportunities = [".NET Developer", "Full Stack .NET Engineer", "ASP.NET Developer", "C# Programmer", "Software Engineer"];

  return (
    <DarkModeProvider>
      <SEO title="Full Stack .NET Development Course - ASP.NET Core Training" description="Master Full Stack .NET Development with C#, ASP.NET Core, SQL Server, and modern web development. Get certified with placement support." keywords="dot net course, .NET training, ASP.NET Core, C# programming, full stack .NET developer" canonical="/full-stack-dotnet-development" ogImage="/images/course images/dotnet.png" category="IT Courses" />
      <CourseStructuredData name="Full Stack .NET Development" description="Complete .NET development training with ASP.NET Core, C#, and SQL Server." url="https://quastech.co.in/full-stack-dotnet-development" duration="P6M" courseMode="blended" image="https://quastech.co.in/images/course images/dotnet.png" />
      <BreadcrumbStructuredData items={[{ name: "Home", url: "/" }, { name: "Courses", url: "/#courses" }, { name: "Full Stack .NET Development", url: "/full-stack-dotnet-development" }]} />
          ...
          <div className="relative z-10 container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div className="text-white space-y-6">
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex items-center gap-2 text-sm"><Link to="/" className="hover:text-white"><Home className="w-4 h-4 inline" /> Home</Link><ChevronRight className="w-4 h-4" /><span>Full Stack .NET Development</span></motion.div>
                <h1 className="text-5xl font-bold">Full Stack .NET Development</h1>
                <p className="text-xl">Master ASP.NET Core and modern web development</p>
              ...
              <img src="/images/front-end-dveleopment.png" alt=".NET Development" className="hidden lg:block" onError={(e) => e.currentTarget.src = "/placeholder.svg"} />
            </div>
          </div>
        </section>
